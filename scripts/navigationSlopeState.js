window.addEventListener('load', () => {
  ...
  data[1] = [ {number: '1', name: 'Talabfahrt Russbach Sektion 1', difficulty: 'red', state: 'closed', location: 'Russbach'},
  ...
  data[2] = [ {number: '9', name: 'Familienabfahrt Zwieselalm', difficulty: 'blue', state: 'closed', location: 'Zwieselalm'},
